    ...
    <body>
        <?php
            ...
            try {
                ...
                # Se reciben desde el input 'Gerente_de_Proyecto' y 'Link'
                $Gerente_de_Proyecto=$_GET['Gerente_de_Proyecto'];
                $Link=$_GET['Link'];
                ...
                if (count($result1) < 1) {
                    ...
                    # Consulta para actualizar gerente del proyecto
                    $query="UPDATE Proyecto
                            SET Gerente_de_Proyecto=:Gerente_de_Proyecto
                            WHERE Link=:Link";
                    $stmt = $pdo->prepare($query);
                    $stmt->bindValue(':Gerente_de_Proyecto', $Gerente_de_Proyecto, PDO::PARAM_STR);
