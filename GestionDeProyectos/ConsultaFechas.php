...
<body>
    <?php
        ...
        try {
            ...
            # Se reciben desde el input 'input1' e 'input2'
            $variable1=$_GET['input1'];
            $variable2=$_GET['input2'];

            # Consulta para mostrar proyectos en base a un nombre de cliente
            $query="SELECT Proyecto.ID, Cliente.Nombre as Nombre_Cliente, Cliente.Link as Link_Cliente, Proyecto.Nombre_Proyecto, Proyecto.Categoría, Proyecto.Fecha,
                        ...
                        FROM Proyecto
                            ...
                            WHERE Proyecto.Fecha 
                                    BETWEEN :valor1 
                                    AND :valor2 
                                ORDER BY Proyecto.Fecha DESC";
            $stmt = $pdo->prepare($query);
            $stmt->bindParam(':valor1', $variable1);
            $stmt->bindParam(':valor2', $variable2);
            $stmt->execute();
