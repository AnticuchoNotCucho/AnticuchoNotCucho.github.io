    ...
    <body>
        <?php
            ...
            try {
                ...
                # Se reciben desde el input 'Nombre_Proyecto' y 'Link'
                ...
                if (count($result1) < 1) {
                    ...
                    # Consulta para actualizar nombre del proyecto
                    $query="UPDATE Proyecto
                            SET Nombre_Proyecto=:Nombre_Proyecto
                            WHERE Link=:Link";
                    $stmt = $pdo->prepare($query);
                    $stmt->bindValue(':Nombre_Proyecto', $Nombre_Proyecto, PDO::PARAM_STR);
