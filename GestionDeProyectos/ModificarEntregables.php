    ...
    <body>
        <?php
            ...
            try {
                ...
                # Se reciben desde el input 'Entregables' y 'Link'
                ...
                if (count($result1) < 1) {
                    ...
                    # Consulta para actualizar entregables del proyecto
                    $query="UPDATE Proyecto
                            SET Entregables=:Entregables
                            WHERE Link=:Link";
                    $stmt = $pdo->prepare($query);
                    $stmt->bindValue(':Entregables', $Entregables, PDO::PARAM_STR);
