    ...
    <body>
        <?php
            ...
            try {
                ...
                # Se reciben desde el input 'Objetivo_del_Proyecto' y 'Link'
                $Objetivo_del_Proyecto=$_GET['Objetivo_del_Proyecto'];
                $Link=$_GET['Link'];
                ...
                if (count($result1) < 1) {
                    ...
                    # Consulta para actualizar objetivo del proyecto
                    $query="UPDATE Proyecto
                            SET Objetivo_del_Proyecto=:Objetivo_del_Proyecto
                            WHERE Link=:Link";
                    $stmt = $pdo->prepare($query);
                    $stmt->bindValue(':Objetivo_del_Proyecto', $Objetivo_del_Proyecto, PDO::PARAM_STR);
