    ...
    <body>
        <?php
            ...
            try {
                ...
                # Se reciben desde el input 'new_Link' y 'Cliente'.
                $new_Link = $_GET['new_Link'];
                $Patrocinador = $_GET['Patrocinador_Principal'];
            
                # Consulta para saber si existe algún patrocinador con el nombre introducido
                $query2="SELECT ID 
                            FROM Patrocinador
                            WHERE Nombre=:Patrocinador";
                $stmt2 = $pdo->prepare($query2);
                $stmt2->bindValue(':Patrocinador', $Patrocinador, PDO::PARAM_STR);
                $stmt2->execute();
                ...
                if(count($result1) < 1)  {
                    ...
                    echo "No existe ningún patrocinador con el nombre introducido. No es posible realizar modificaciones.";
                    echo "</div>";
                } else {
                    ...
                    $stmt->bindValue(':Patrocinador', $Patrocinador, PDO::PARAM_STR);
                    $stmt->execute();
                    ...
                    echo "<tr>
                          ...
                          <th> LinkedIn de Patrocinador </th>      
                        </tr>";     
